...
import unicorn.arubis.exceptions.AccountException;
...
public interface IAccount {
    ...
    /**
     * Resetea la contraseña de una cuenta sin requerir la contraseña actual.
     * Método típicamente usado por administradores.
     *                          La nueva contraseña debe cumplir con la validación de AccountValidation:
     *                              - Al menos 8 caracteres
     *                              - Al menos una letra mayúscula
     *                              - Al menos un dígito numérico
