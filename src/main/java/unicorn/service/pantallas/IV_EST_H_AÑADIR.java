 ...
 * @author KNOW-RIC
 */
public class IV_EST_H_AÑADIR extends javax.swing.JFrame {
     ...
     * @param account
     */
    public IV_EST_H_AÑADIR(Account account) {
    ...
    private void initComponents() {
        ...
        TBL_H_AÑADIR = new javax.swing.JScrollPane();
        DTO_H_AÑADIR = new javax.swing.JTable();
        ...
        FONDO.add(BTN_VOLVER, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 690, 250, 40));

        BTN_SELECCIONAR.setBackground(new java.awt.Color(32, 97, 96));
        BTN_SELECCIONAR.setFont(new java.awt.Font("Fira Code", 1, 24)); // NOI18N
        BTN_SELECCIONAR.setForeground(new java.awt.Color(10, 15, 34));
        BTN_SELECCIONAR.setText("SELECCIONAR ");
        BTN_SELECCIONAR.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        BTN_SELECCIONAR.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BTN_SELECCIONARActionPerformed(evt);
            }
        });
        FONDO.add(BTN_SELECCIONAR, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 690, 250, 40));

        DTO_H_AÑADIR.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "HORA", "DIAS ", "MATERIA", "AULA", "DOCENTE "
            }
        ));
        TBL_H_AÑADIR.setViewportView(DTO_H_AÑADIR);

        FONDO.add(TBL_H_AÑADIR, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 190, 830, 440));
    ...
    private void BTN_MIHORARIOActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTN_MIHORARIOActionPerformed
        IV_EST_H_AÑADIR registerScreen = new IV_EST_H_AÑADIR(account);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IV_EST_H_AÑADIR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new IV_EST_H_AÑADIR(null).setVisible(true);
        });
    }
    ...
    private javax.swing.JTable DTO_H_AÑADIR;
    private javax.swing.JPanel FONDO;
    private javax.swing.JPanel PNL_OPTION;
    private javax.swing.JPanel PNL_TOP;
    private javax.swing.JScrollPane TBL_H_AÑADIR;
