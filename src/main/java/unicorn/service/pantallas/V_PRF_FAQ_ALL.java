 ...
 * @author KNOW-RIC
 */
public class V_PRF_FAQ_ALL extends javax.swing.JFrame {
     ...
     * @param account
     */
    public V_PRF_FAQ_ALL(Account account) {
    ...
    private void BTN_FaQActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTN_FaQActionPerformed
        V_PRF_FAQ_ALL registerScreen = new V_PRF_FAQ_ALL(account);
        registerScreen.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(V_PRF_FAQ_ALL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new V_PRF_FAQ_ALL(null).setVisible(true);
        });
    }
