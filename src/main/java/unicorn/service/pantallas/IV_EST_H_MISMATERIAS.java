 ...
 * @author KNOW-RIC
 */
public class IV_EST_H_MISMATERIAS extends javax.swing.JFrame {
     ...
     * @param account
     */
    public IV_EST_H_MISMATERIAS(Account account) {
    ...
    private void initComponents() {
        ...
        TBL_MISMATERIAS = new javax.swing.JScrollPane();
        DTO_MISMATERIAS = new javax.swing.JTable();
        ...
        BIENVENIDA.setText("MIS MATERIAS ");
        ...
        FONDO.add(BTN_VOLVER, new org.netbeans.lib.awtextra.AbsoluteConstraints(1070, 700, 250, 40));

        DTO_MISMATERIAS.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        TBL_MISMATERIAS.setViewportView(DTO_MISMATERIAS);

        FONDO.add(TBL_MISMATERIAS, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 180, 520, 460));
    ...
    private void BTN_MIHORARIOActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTN_MIHORARIOActionPerformed
        IV_EST_H_MISMATERIAS registerScreen = new IV_EST_H_MISMATERIAS(account);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IV_EST_H_MISMATERIAS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new IV_EST_H_MISMATERIAS(null).setVisible(true);
        });
    }
    ...
    private javax.swing.JTable DTO_MISMATERIAS;
    private javax.swing.JPanel FONDO;
    private javax.swing.JPanel PNL_OPTION;
    private javax.swing.JPanel PNL_TOP;
    private javax.swing.JScrollPane TBL_MISMATERIAS;
