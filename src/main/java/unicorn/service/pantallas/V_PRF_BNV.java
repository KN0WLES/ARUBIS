 ...
 * @author KNOW-RIC
 */
public class V_PRF_BNV extends javax.swing.JFrame {
     ...
     * @param account
     */
    public V_PRF_BNV(Account account) {
    ...
    private void initComponents() {
        ...
        PNL_TOPLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, PNL_TOPLayout.createSequentialGroup()
                ...
                .addComponent(TITULO)
                .addGap(28, 28, 28)
                .addComponent(BIENVENIDA, javax.swing.GroupLayout.DEFAULT_SIZE, 781, Short.MAX_VALUE)
                .addGap(18, 18, 18)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(V_PRF_BNV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new V_PRF_BNV(null).setVisible(true);
        });
    }
