 ...
 * @author KNOW-RIC
 */
public class V_PRF_FAQ extends javax.swing.JFrame {
     ...
     * @param account
     */
    public V_PRF_FAQ(Account account) {
    ...
    private void BTN_FaQActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTN_FaQActionPerformed
        V_PRF_FAQ registerScreen = new V_PRF_FAQ(account);
        registerScreen.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(V_PRF_FAQ.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new V_PRF_FAQ(null).setVisible(true);
        });
    }
