 ...
 * @author KNOW-RIC
 */
public class IV_EST_FAQ_ALL extends javax.swing.JFrame {
     ...
     * @param account
     */
    public IV_EST_FAQ_ALL(Account account) {
    ...
    private void initComponents() {
        ...
        DTO_HISTORY.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "PREGUNTA", "RESPUESTA", "FECHA DE RESPUESTA", "USUARIO"
            }
        ));
        TBL_ALL_FAQ.setViewportView(DTO_HISTORY);

        FONDO.add(TBL_ALL_FAQ, new org.netbeans.lib.awtextra.AbsoluteConstraints(335, 220, 1010, 410));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IV_EST_FAQ_ALL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new IV_EST_FAQ_ALL(null).setVisible(true);
        });
    }
